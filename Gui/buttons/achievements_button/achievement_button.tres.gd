...
@icon("res://assets/textures/node_icons/achivment_icon.png")
class_name AchievementButton_
extends Button
...
func setup_panel_node() -> AchievementSubPanel:
	var subpanel:AchievementSubPanel = achievement.instantiate()
